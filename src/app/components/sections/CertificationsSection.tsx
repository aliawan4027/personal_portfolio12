  ...
  return (
    ...
    >
      ...
      <div className="mt-6 grid gap-6 sm:grid-cols-2">
        <div>
          <h3 className="text-sm font-semibold text-[var(--foreground)]">{t('certifications.categories.seo')}</h3>
          <div className="mt-2 space-y-2">
            {seoCerts.map((cert) => {
              const content = (
                <RandomColorCard className="rounded-lg bg-[var(--bg-elevated)] px-3 py-2 text-xs text-[var(--foreground)] group">
        ...
        <div>
          <h3 className="text-sm font-semibold text-[var(--foreground)]">{t('certifications.categories.development')}</h3>
          <div className="mt-2 space-y-2">
            {otherCerts.map((cert) => {
              const content = (
                <RandomColorCard className="rounded-lg bg-[var(--bg-elevated)] px-3 py-2 text-xs text-[var(--foreground)] group">
